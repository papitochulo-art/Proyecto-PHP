...
?>
    ...
    <body>
        <div class="container-fluid">
            ...
            <form action="modificartalla2.php" method="post">
            ...
            <th>Modificar</th>
                ...
                <?php
                    ...
                    while($columnas=$resultado->fetch(PDO::FETCH_ASSOC)){
                        for ($i = 0; $i < count($arrayColumnas); $i++){
                            if($i==0) print "<tr><td><input type='radio' name='modificartalla' value='".$columnas[$arrayColumnas[$i]]."'></td><td>".$columnas[$arrayColumnas[$i]]."</td>";
