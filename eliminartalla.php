...
if (!isset($_SESSION["usuario"])) header("Location:login.php");
    ...
    if (isset($_POST["lista"])) {
        ...
        foreach ($lista as $valor) {
            $eliminar = "DELETE FROM tallas where id=?";
            try {
                $resultado = $db->prepare($eliminar);
                $resultado->execute([$valor]);
                if ($resultado) header("index.php");
                else print "Error";
            } catch (PDOException $e) {
                print $e->getMessage();
            };
        }
    }else header("Location:eliminartalla.php?error='error'");
    }
...
?>
    ...
    <body>
        <div class="container-fluid">
            ...
            <form action="eliminartalla.php" method="post">
            ...
            <th>Eliminar</th>
                ...
                <?php
                    ...
                    if(isset($_REQUEST["error"])) print "<p style='color:red;'>No has seleccionado ninguna talla</p>";
                } catch (PDOException $e) {
                    print $e->getMessage();
                }
                ?>
